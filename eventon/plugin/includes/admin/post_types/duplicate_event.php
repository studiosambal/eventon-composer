	...
	function eventon_duplicate_event() {
		...
		if (isset($post) && $post!=null) {
			...
			if($new_id){
				...
				do_action( 'eventon_duplicate_product', $new_id, $post );// deprecating
...
// Duplicate post meta for the event
	function eventon_duplicate_post_meta($id, $new_id) {
		...
		$exclude = array_map( 'esc_sql', array_filter( apply_filters( 'eventon_duplicate_event_exclude_meta', array() ) ) );
