...
class Evo_Shortcode_Fields{
	...
	public function get_fields($key){
		...
		$SC_defaults = apply_filters('evo_shortcode_fields', array(
			'cal_id'=>array(
			...
			'UIX'=>array(
				...
				'options'=>apply_filters('eventon_uix_shortcode_opts', array(
					'0'=> __('Default Event UX action','eventon'),	//4.6.2				
			...
			'filter_clear'=>array(
				...
				'type'=>'YN',
				'guide'=>__('This will show clear filters button on filter bar to reset the set filters back to default values. Only available with multiple checkbox filter type.','eventon'),
				'var'=>'filter_clear',
				'default'=>'no',
			),
